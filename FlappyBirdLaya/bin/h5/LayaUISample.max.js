...
Laya.interface('GameState.IGameStateBase');
...
var GameStateController=(function(){
	function GameStateController(){
		this.m_curGameState=null;
		this.m_gameStateInit=null;
		this.m_gameStateLoading=null;
		this.m_gameStatePlaying=null;
		this.m_gameStatePause=null;
		this.m_gameStateOver=null;
		this.m_gameStateInit=new GameStateInit();
		this.m_gameStateLoading=new GameStateLoading();
		this.m_gameStatePlaying=new GameStatePlaying();
		this.m_gameStatePause=new GameStatePause();
		this.m_gameStateOver=new GameStateOver();
	}

	__class(GameStateController,'GameState.GameStateController');
	var __proto=GameStateController.prototype;
	__proto.OnStart=function(){}
	__proto.OnExit=function(){}
	__proto.OnLoop=function(){
		if(this.m_curGameState !=null){
			this.m_curGameState.OnLoop();
		}
	}

	__proto.GetGameState=function(gameStateId){
		var gameState=this.m_gameStateInit;
		switch(gameStateId){
			case 1:gameState=this.m_gameStateInit;break ;
			case 2:gameState=this.m_gameStateLoading;break ;
			case 3:gameState=this.m_gameStatePause;break ;
			case 4:gameState=this.m_gameStatePlaying;break ;
			case 5:gameState=this.m_gameStateOver;break ;
			}
		return gameState;
	}

	__proto.ChangeState=function(gameStateId){
		if(this.m_curGameState !=null){
			this.m_curGameState.OnExit();
		};
		var gameState=this.GetGameState(gameStateId);
		this.m_curGameState=gameState;
		if(this.m_curGameState !=null){
			this.m_curGameState.OnStart();
		}
	}

	__getset(1,GameStateController,'instance',function(){
		if(GameStateController.s_instance==null){
			GameStateController.s_instance=new GameStateController();
		}
		return GameState.GameStateController.s_instance;
	});

	GameStateController.s_instance=null;
...
*@author
*/
//class GameState.GameStateInit
var GameStateInit=(function(){
	function GameStateInit(){}
	__class(GameStateInit,'GameState.GameStateInit');
	var __proto=GameStateInit.prototype;
	Laya.imps(__proto,{"GameState.IGameStateBase":true})
	__proto.OnStart=function(){
		MiniAdpter.init();
		Laya.init(1136,640);
	...
	__proto.OnVersionLoaded=function(){
		GameStateController.instance.ChangeState(2);
	}
...
*@author
*/
//class GameState.GameStateLoading
var GameStateLoading=(function(){
	function GameStateLoading(){
		/***游戏资源地址数组***/
		this.m_assetArr=[{url:"res/atlas/comp.atlas",type:"atlas"},
		{url:"res/atlas/GameHero.atlas",type:"atlas"},
		{url:"res/atlas/GameMap.atlas",type:"atlas"},
		{url:"res/atlas/GameUI.atlas",type:"atlas"},
		{url:"res/sound/BackgroundMusic.wav",type:"sound"},
		{url:"res/sound/BirdFlap.wav",type:"sound"},
		{url:"res/sound/Scored.wav",type:"sound"},
		{url:"res/sound/StartMenuMusic.mp3",type:"sound"},
		{url:"res/sound/GameOver.wav",type:"sound"},];
	}

	__class(GameStateLoading,'GameState.GameStateLoading');
	var __proto=GameStateLoading.prototype;
	Laya.imps(__proto,{"GameState.IGameStateBase":true})
	__proto.OnStart=function(){
		Laya.loader.load(this.m_assetArr,Handler.create(this,this.OnAssetsLoaded));
	}

	__proto.OnExit=function(){}
	__proto.OnLoop=function(){}
	__proto.OnAssetsLoaded=function(){
		GameStateController.instance.ChangeState(3);
	}
...
*@author
*/
//class GameState.GameStateOver
var GameStateOver=(function(){
	function GameStateOver(){}
	__class(GameStateOver,'GameState.GameStateOver');
	var __proto=GameStateOver.prototype;
	Laya.imps(__proto,{"GameState.IGameStateBase":true})
	__proto.OnStart=function(){}
	__proto.OnExit=function(){}
	__proto.OnLoop=function(){}
...
*@author
*/
//class GameState.GameStatePause
var GameStatePause=(function(){
	function GameStatePause(){}
	__class(GameStatePause,'GameState.GameStatePause');
	var __proto=GameStatePause.prototype;
	Laya.imps(__proto,{"GameState.IGameStateBase":true})
	__proto.OnStart=function(){
		var gameStartView=new GameStart();
...
*@author
*/
//class GameState.GameStatePlaying
var GameStatePlaying=(function(){
	function GameStatePlaying(){}
	__class(GameStatePlaying,'GameState.GameStatePlaying');
	var __proto=GameStatePlaying.prototype;
	Laya.imps(__proto,{"GameState.IGameStateBase":true})
	__proto.OnStart=function(){}
	__proto.OnExit=function(){}
	__proto.OnLoop=function(){}
...
*@author
*/
//class GameState.TGameState
var TGameState=(function(){
	function TGameState(){}
	__class(TGameState,'GameState.TGameState');
	TGameState.INIT=1;
	TGameState.LOADING=2;
	TGameState.PAUSE=3;
	TGameState.PLAYING=4;
	TGameState.OVER=5;
	return TGameState;
})()
...
var LayaUISample=(function(){
	function LayaUISample(){
		GameStateController.instance.ChangeState(1);
	}
...
//class ui.GameUI.GameStartUI extends laya.ui.View
var GameStartUI=(function(_super){
	...
	__class(GameStartUI,'ui.GameUI.GameStartUI',_super);
...
//class view.GameUI.GameStart extends ui.GameUI.GameStartUI
var GameStart=(function(_super){
	function GameStart(){
		GameStart.__super.call(this);
		this.m_btnStart.on("click",this,this.onBtnClick);
	}

	__class(GameStart,'view.GameUI.GameStart',_super);
	var __proto=GameStart.prototype;
	__proto.onBtnClick=function(e){
		console.debug("m_btnStart Click");
		Log.print("m_btnStart Click");
	}
